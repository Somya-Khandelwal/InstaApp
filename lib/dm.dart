...
class DmState extends State<Dm> {
  ...
  static final List a = [
  "https://images.wallpapersden.com/image/download/camila-cabello-as-cinderella_bG1qZmiUmZqaraWkpJRobWllrWdma2U.jpg",
  ...
  static final List b =["Camila", "Shawn", "PikiChops", "Taylor", "Jeon", "Aditya", "Sweet", "MsCHappy","messi", "CR7", "SK","Handey","jon","Ash","ijso"];
  static final List c =[
    "Have a nice day, bro!..\n.now",
    "Have a nice day, M L!..\n.now",
